...
Promise.all(stuffToDo)
  .then(data => console.log('Promise.all() Response Array', data))
  .catch(console.error);


// Promise.race(stuffToDo).then(data => console.log('Promise.race() Response Array', data)).catch(console.error);
